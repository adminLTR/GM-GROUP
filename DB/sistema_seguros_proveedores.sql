...
CREATE TABLE `proveedores` (
  ...
  KEY `fk_proveedores_empresa` (`id_empresa`),
  CONSTRAINT `fk_proveedores_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresas_brokers` (`id_empresa`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-05-02 13:23:28
