...
CREATE TABLE `gestiones` (
  ...
  `tipo_gestion` enum('Llamada','Correo','Reunión','Otro') DEFAULT 'Otro',
  PRIMARY KEY (`id_gestion`),
  KEY `id_persona` (`id_persona`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `gestiones_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id_persona`) ON DELETE CASCADE,
  CONSTRAINT `gestiones_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL
...
-- Dump completed on 2025-05-02 13:30:31
