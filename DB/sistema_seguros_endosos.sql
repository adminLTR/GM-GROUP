...
CREATE TABLE `endosos` (
  ...
  CONSTRAINT `endosos_ibfk_1` FOREIGN KEY (`poliza_id`) REFERENCES `polizas` (`id_poliza`) ON DELETE CASCADE,
  CONSTRAINT `endosos_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
