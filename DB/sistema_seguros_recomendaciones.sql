...
CREATE TABLE `recomendaciones` (
  ...
  `id_persona_recomienda` int NOT NULL,
  `id_poliza` int NOT NULL,
  `fecha_recomendacion` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `porcentaje_puntos` decimal(5,2) NOT NULL,
  `puntos_generados` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id_recomendacion`),
  KEY `id_persona_recomienda` (`id_persona_recomienda`),
  KEY `id_poliza` (`id_poliza`),
  CONSTRAINT `recomendaciones_ibfk_1` FOREIGN KEY (`id_persona_recomienda`) REFERENCES `persona` (`id_persona`)
...
-- Dump completed on 2025-05-02 13:28:53
