...
CREATE TABLE `categorias_gastos` (
  ...
  KEY `fk_categorias_empresa` (`id_empresa`),
  CONSTRAINT `fk_categorias_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresas_brokers` (`id_empresa`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-05-02 13:29:57
