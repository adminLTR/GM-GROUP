...
CREATE TABLE `observaciones` (
  ...
  CONSTRAINT `observaciones_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
...
INSERT INTO `observaciones` VALUES (1,19,'Este tipo es complicadito','2025-02-20 17:04:03',2),(2,18,'.','2025-03-04 00:12:29',2);
...
-- Dump completed on 2025-05-02 13:29:15
